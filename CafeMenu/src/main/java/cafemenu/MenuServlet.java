...
public class MenuServlet extends HttpServlet {
    ...
    private void initializeDefaultMenu() {
        ...
        menu.add(new MenuItem("Vanilla Latte", "Coffee", "Hot", "", 130, 65, 1));
        ...
        menu.add(new MenuItem("Ham & Cheese Sandwich", "Sandwiches", "", "", 130, 82, 0));
    ...
    private String getImageFile(MenuItem item) {
        if (item.getCategory().equalsIgnoreCase("Bread and Pastry")) return "Bread.png";
        return item.getCategory().replace(" & ", "").replace(" ", "") + ".png";
    }
